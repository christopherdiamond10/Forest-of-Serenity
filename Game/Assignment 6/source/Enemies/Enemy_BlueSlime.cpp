...
Enemy_BlueSlime::Enemy_BlueSlime()  : Enemy()
{
	Onload();
	Enemy::OnLoad();
}

Enemy_BlueSlime::~Enemy_BlueSlime()
{

}

void Enemy_BlueSlime::Onload()
{
	AnimatedSprite::SetCurrentTexture("Enemy_BlueSlime.png", "Sprites");
...
void Enemy_BlueSlime::OnUnload()
{

}

void Enemy_BlueSlime::Update( Vector2 &v2CameraPos )
{

...
Enemy_GreenSlime::Enemy_GreenSlime()  : Enemy()
{
	Onload();
	Enemy::OnLoad();
}

Enemy_GreenSlime::~Enemy_GreenSlime()
{

}

void Enemy_GreenSlime::Onload()
{
	AnimatedSprite::SetCurrentTexture("Enemy_GreenSlime.png", "Sprites");
...
void Enemy_GreenSlime::OnUnload()
{

}

void Enemy_GreenSlime::Update( Vector2 &v2CameraPos )
{
